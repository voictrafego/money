...
- [ ] **VOL-01**: A engine adiciona a família **Volume** (média móvel de volume + flag "rompimento com volume acima da média") como confirmação, de forma aditiva ao contrato `SinaisTecnicos`.
