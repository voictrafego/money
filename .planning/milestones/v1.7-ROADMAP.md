...
Plans:
- [x] 21-01-PLAN.md — Comparador multi-ativo: normalizar_tickers + comparador.montar_comparativo (transposto, selo por coluna) na engine + 5º menu read-only em app.py (COMP-01/02/03)
