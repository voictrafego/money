...
| Fiscal/NF | **CONFIGURADO no Asaas (2026-07-09).** Módulo NFS-e via Portal Nacional montado: login (certificado + user/senha), serviço cadastrado (**Código de serviço `01.03.01`**, **Tributação nacional `010301`** — Processamento de dados e sistemas de informação, item LC116 1.03; serviço padrão), Simples Nacional, inscrição municipal 3813487, certificado A1 enviado. CNAE base: **6319-4/00** (já no contrato social — não usar consultoria/financeiro). Empresa: G Pereira Lazari Consultoria em Publicidade LTDA, ME, Londrina/PR. **Falta só:** ligar a **emissão automática por assinatura** (quando abrir comercialmente) + confirmar a alíquota/anexo de ISS com o contador (usado 0/Simples por ora). Emissão ADIADA enquanto em beta (sem clientes reais). | v2.1 | 2026-07-09 |
